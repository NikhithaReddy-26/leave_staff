...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Vjit Leave Manager</title>

	<!-- Site favicon -->
	<link rel="apple-touch-icon" sizes="180x180" href="vendors/images/desktop1.png">
	<link rel="icon" type="image/png" sizes="32x32" href="vendors/images/favicon1.png">
	<link rel="icon" type="image/png" sizes="16x16" href="vendors/images/fevicon.png">
	...
	<div class="login-header box-shadow">
		<div class="container-fluid d-flex justify-content-between align-items-center">
			<div class="brand-logo">
				<a href="login.html">
					<img src="vendors/images/desktop1.png" alt="">
				</a>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-md-6 col-lg-7">
					<img src="vendors/images/desktop4.png" alt="">
				</div>
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<h2 class="text-center text-primary">Welcome To Vjit Leave</h2>
						</div>
